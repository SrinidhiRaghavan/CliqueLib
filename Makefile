...
CC = g++-6
CXX = g++-6
INCLUDES = -I ./armadillo-7.800.2/include/ -I ./source/Commons/ -I./tests -I./source  -I./source/Preprocessing -I./source/KNN -I./source/KNNStd -I./source/LogisticRegression -I./source/LogisticRegressionStd -I./source/NaiveBayes -I./source/AdaBoost
CXXFLAGS = -g -Wall --std=c++1z -fconcepts -o prog -O2 -larmadillo $(INCLUDES) 
LDFLAGS = -L ./armadillo-7.800.2/include/armadillo
LDLIBS  =

main: tests/test_read_csv.o tests/test_split_test_train_dataset.o tests/test_knn.o tests/test_knn_std.o tests/test_logistic_regression.o tests/test_logistic_regression_std.o tests/test_naive_bayes.o tests/test_adaboost.o source/Preprocessing/preprocessing_functions.o source/KNN/knn.o source/KNNStd/knnstd.o source/LogisticRegression/logistic_regression.o source/LogisticRegressionStd/logistic_regression_std.o source/NaiveBayes/naive_bayes.o source/AdaBoost/Stump.o source/AdaBoost/AdaBoost.o source/AdaBoost/BaggingClassifier.o source/VotingClassifier/VotingClassifier.o source/VotingClassifier/VotingClassifier.o
