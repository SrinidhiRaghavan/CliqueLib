...
void test_read_csv()
{
    ...
    read_csv("./samples_csv/test_file_4_separate_ex_space.csv", ' ');

    //Test 5
    std::cout << "\nTESTING READING CSV FILE 5" << std::endl;
    read_csv("./samples_csv/test_file_5_separate_ex_semicolon.csv", ';');

    //Test 6
    std::cout << "\nTESTING READING CSV FILE 6" << std::endl;
    read_csv("./samples_csv/test_file_6_separate_ex_default.csv");

    //Test 7
    std::cout << "\nTESTING READING CSV FILE 7" << std::endl;
    read_csv("./samples_csv/test_file_7_comment_*.csv", ',', '*');
